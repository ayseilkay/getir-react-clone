      ...
      <div className="md:container flex justify-between items-center relative md:absolute top-0 left-0 md:left-1/2 translate-x-0 md:-translate-x-1/2 h-full z-20">
        ...
        <div className="w-full md:w-[400px] md:rounded-lg bg-gray-50 p-6">
          ...
          <div class="grid gap-y-3">
            ...
            <button className="bg-primary-button-color text-primary-brand-color transition-colors hover:bg-primary-brand-color hover:text-primary-button-color h-12 flex items-center justify-center rounded-md w-full text-sm font-semibold ">
