...
function Product({product:{id,title,image,alt,price}}) {
  return (
    <div className='bg-white flex flex-col items-center text-center gap-y-1 p-3 relative w-full h-full'>
        <div className=''>
        ...
        <div className='text-color-black font-semibold flex items-center justify-center flex-shrink-0'>{title}</div>
